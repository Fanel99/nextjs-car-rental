        ...
        <div className="afterImgTextWrapper">
          <div className="afterImgText">
            <p>
              ...
              budding entrepreneurs the tools and resources they need to build a
              small, successful portfolio of cars to share on the marketplace,
              and the opportunity to add thousands to their annual income.{' '}
              <br />
      ...
      <section css={buildBusiness}>
        ...
        <div className="businessContent">
          ...
          <div>
            <h4>Flexible</h4>
            <p>
              Whether you want to commit a lot of time or a little, you can earn
              at home or on the go, on your schedule, and divest any time.
            </p>
          </div>
        </div>
      </section>
